  ...
  AwesomeNotifications().initialize(
      ...
      channelGroups: [
        NotificationChannelGroup(
            channelGroupName: 'calls', channelGroupKey: 'calls'),
      ],
      debug: true);
...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  // Call the setNotifications method to initialize FCM
  FCM().setNotifications();

// Now you can parse the notification message
//   FCM().parseNotificationMessage(message);
}
