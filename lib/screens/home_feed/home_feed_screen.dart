      ...
      if (_homeController.polls.length > pollIndex) {
        return Container(
          ...
          child: FlutterPolls(
            ...
            // userVotedOptionId: _homeController.polls[pollIndex].isVote != null && _homeController.polls[pollIndex].isVote! > 0
            //     ? int.parse(_homeController.polls[pollIndex].isVote!.toString())
            //     : null,
            onVoted: (PollOption pollOption, int newTotalVotes) async {
              await Future.delayed(const Duration(seconds: 1));
              _homeController.postPollAnswer(
                  _homeController.polls[pollIndex].pollId!,
                  _homeController.polls[pollIndex].id.toString()
                      as int, // Convert id to String
                  pollOption.id.toString() as int // Convert id to String
                  );
            ...
            //         // Provide a default value of 0 if totalOptionVoteCount is null
            //       );
            //       return a;
            //     },
            //   ),
